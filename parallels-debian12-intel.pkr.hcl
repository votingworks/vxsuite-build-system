...
variable "iso_checksum" {
  type = string
  default = "d969b315de093bc065b4f12ab0dd3f5601b52d67a0c622627c899f1d35834b82"
}

variable "iso_name" {
  type = string
  default = "debian-12.2.0-amd64-DVD-1.iso"
}
...
variable "mirror_directory" {
  type = string
  default = "12.2.0/amd64/iso-dvd"
}

variable "name" {
  type = string
  default = "debian-12.2-amd64"
}
...
source "parallels-iso" "debian12-intel" {
  boot_command = [
...
build {
  name = "parallels-demo"
  sources = ["source.parallels-iso.debian12-intel"]
