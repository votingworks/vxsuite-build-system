...
s3_path="s3://votingworks-trusted-build/signed/${vm_version}/"
...
echo ""
echo "Calculating sha256 hashes of all signed files."
...
echo ""
echo "Uploading signed files to ${s3_path}. This will take a few minutes."
...
echo ""
echo "The signed upload process is now complete."
echo ""
