...
log "  - openssh-server purged (finalize unit)"
log "  - ${VM_SUDOERS_FILE}, ${VM_BUILD_MARKER}, the logname shim and"
log "    everything under ${VM_HOME} removed (vx-cleanup, at shutdown)"
log ""
